...
export default function humanSize(fileOrBytes, descriptor = {locale: "fr", round: 1}) {

    let bytes = fileOrBytes;
    if (fileOrBytes && fileOrBytes instanceof File) {
        bytes = fileOrBytes.size;
    }

    let result = [],
        val = 0,
        e, base, bits, ceil, full, fullforms, locale, localeOptions, neg, num, output, pad, round, u, unix, separator,
        spacer, standard, symbols, roundingFunc, precision;
